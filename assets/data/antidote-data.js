window.SBTI_ANTIDOTE_DATA = {
    ...
    "prescriptions": {
        ...
        "BOSS": {
            "code": "BOSS",
            "displayName": "领导者",
            "prescriptionName": "领导者松肩",
            "direction": "高压推进、任务卸载",
            "status": "高压推进、强掌控、身心紧绷。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "THANK": {
            "code": "THANK",
            "displayName": "感恩者",
            "prescriptionName": "把感谢留给自己",
            "direction": "感恩、自我照顾、需求觉察",
            "status": "过度感恩、压抑需求、总替他人解释。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "GOGO": {
            "code": "GOGO",
            "displayName": "行者",
            "prescriptionName": "出发也要落地",
            "direction": "行动焦虑、启动与收束",
            "status": "行动焦虑、停不下来、启动快但收束难。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "AURA": {
            "code": "AURA",
            "displayName": "尤物",
            "prescriptionName": "回到身体",
            "direction": "身体接纳、感官觉察",
            "status": "身体接纳、亲密自信、外界目光过载。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "LOVE": {
            "code": "LOVE",
            "displayName": "多情者",
            "prescriptionName": "爱意不外包",
            "direction": "关系依恋、自我陪伴",
            "status": "关系依恋、爱意很满、期待被回应。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "WARM": {
            "code": "WARM",
            "displayName": "妈妈",
            "prescriptionName": "照顾者充电",
            "direction": "照顾者疲惫、慈心、自我修复",
            "status": "照顾者疲惫、共情过载、总把药给别人。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "FAKE": {
            "code": "FAKE",
            "displayName": "面具型",
            "prescriptionName": "卸下面具",
            "direction": "社交面具、真实表达",
            "status": "社交面具、真实表达困难、切换角色后感到空。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "THIN-K": {
            "code": "THIN-K",
            "displayName": "思考者",
            "prescriptionName": "脑内会议散会",
            "direction": "过度思考、睡前清空",
            "status": "过度思考、分析过载、睡前脑内会议。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "MONK": {
            "code": "MONK",
            "displayName": "僧人",
            "prescriptionName": "人间联机",
            "direction": "抽离、连接、慈心",
            "status": "抽离人间、边界很强、需要温和连接。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
        ...
        "BOUND": {
            "code": "BOUND",
            "displayName": "孤旅者",
            "prescriptionName": "一个人也被陪着",
            "direction": "孤独、连接、安全感",
            "status": "孤独、主动疏远、连接需求与防御并存。",
            "sensitive": true,
            "practices": [
                {
                    "priority": 1,
        ...
        "VOID": {
            "code": "VOID",
            "displayName": "低电量者",
            "prescriptionName": "恢复一点点感受",
            "direction": "麻木、意义感低、感官重启",
            "status": "麻木、意义感低、什么都没兴趣。",
            "sensitive": true,
            "practices": [
                {
                    "priority": 1,
        ...
        "FREE": {
            "code": "FREE",
            "displayName": "傻乐者",
            "prescriptionName": "笑着先落地",
            "direction": "混合型、基础稳定",
            "status": "混合型、标准人格库不易归类、需要基础稳定练习。",
            "sensitive": false,
            "practices": [
                {
                    "priority": 1,
